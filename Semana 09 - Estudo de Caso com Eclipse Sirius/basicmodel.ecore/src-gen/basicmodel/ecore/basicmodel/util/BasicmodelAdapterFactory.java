/**
 */
package basicmodel.ecore.basicmodel.util;
...
public class BasicmodelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected BasicmodelSwitch<Adapter> modelSwitch = new BasicmodelSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link basicmodel.ecore.basicmodel.Box <em>Box</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link basicmodel.ecore.basicmodel.Stuff <em>Stuff</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
